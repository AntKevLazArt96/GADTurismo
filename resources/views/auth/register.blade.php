            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('fecha_ci') ? ' has-error' : '' }}">
                            <label for="fecha_ci" class="col-md-4 control-label">Fecha Expedicion</label>

                            <div class="col-md-6">
                                <input id="fecha_ci" type="date" class="form-control" name="fecha_ci" value="{{ old('fecha_ci') }}" required autofocus>

                                @if ($errors->has('fecha_ci'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('fecha_ci') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
